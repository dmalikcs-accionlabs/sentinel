...
if AZURE_VAULT_URL:
    ...
    SENTINEL_EMAIL_PARSING_SB_CONNECTION_STRING = os.getenv('SENTINEL_EMAIL_PARSING_SB_CONNECTION_STRING')
    SENTINEL_AP_EMAIL_PARSING_QUEUE_NAME = os.getenv('SENTINEL_AP_EMAIL_PARSING_QUEUE_NAME')

    SENTINEL_PDF_PARSING_SB_CONNECTION_STRING = os.getenv('SENTINEL_PDF_PARSING_SB_CONNECTION_STRING')
    SENTINEL_AP_PDF_PARSING_QUEUE_NAME = os.getenv('SENTINEL_AP_PDF_PARSING_QUEUE_NAME')
